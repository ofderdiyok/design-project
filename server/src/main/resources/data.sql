...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (1, 'Sebzeli Omlet', 'Ogun', 188,
                                                                ...
                                                                20, '1. Yumurtaları bir kasede çırpın.2. Soğanı, domatesleri, biberleri ve mantarları doğrayın.3. Bir tavada yağ ısıtın ve doğranmış sebzeleri kavurun.4. Kavrulmuş sebzelerin üzerine çırpılmış yumurtaları dökün.5. Yumurtalar pişene kadar pişirin.6. Tuz ve biberle servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (2, 'Akdeniz Salatası', 'Salata', 120,
                                                                    ...
                                                                    'https://www.greensalads.com.tr/Upload/urunler/11420232343693akdenizl-salata.jpg',
                                                                                                        15, '1. Salatalıkları, domatesleri ve biberleri doğrayın.2. Zeytinleri ve peyniri dilimleyin.3. Tüm malzemeleri bir kasede karıştırın.4. Taze limon suyu sıkın.5. Tuz ekleyin ve zeytinyağıyla gezdirin.6. İyice karıştırın ve soğuk servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (3, 'Tavuk Sote', 'Ogun', 169,
                                                                    ...
                                                                    'https://i.ytimg.com/vi/SOlm4nkd-J4/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDN4cC5RLM7CSuGSwyMTAumhBvqAA',
                                                                                                        25, '1. Tavuğu lokma büyüklüğünde parçalara kesin.2. Brokoli, havuç, biber, soğan ve sarımsağı doğrayın.3. Bir tavada yağ ısıtın ve ezilmiş sarımsağı ekleyin.4. Tavuk parçalarını ekleyin ve pişene kadar soteleyin.5. Doğranmış sebzeleri ekleyin ve yumuşayana kadar sotelemeye devam edin.6. Tuz, biber ve isteğe bağlı baharatlarla tatlandırın.7. Pilav veya makarna ile sıcak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (4, 'Meyve Smoothie', 'Icecek', 229,
                                                                    ...
                                                                    'https://www.tarifinisevdim.com/uploads/others/cc15e350-0b93-4fb0-82fe-a465bb86792a.Jpeg',
                                                                                                        10, '1. Muz, çilek ve portakalı dilimleyin.2. Tüm malzemeleri blenderda pürüzsüz bir kıvam alana kadar karıştırın.3. İsteğe bağlı olarak buz ekleyin.4. Bardaklara dökün ve taze meyve dilimleri ile süsleyerek servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (5, 'Yeşil Salata', 'Salata', 120,
                                                                    ...
                                                                    'https://www.diyetkolik.com/site_media/media/foodrecipe_images/yesil-salata.jpg',
                                                                                                        10, '1. Marul ve maydanozu iyice yıkayın ve doğrayın.2. Doğranmış yeşil yaprakları bir kaseye alın.3. Üzerine limon suyu sıkarak karıştırın.4. İsteğe bağlı olarak tuz ve zeytinyağı ekleyin.5. Hafifçe karıştırın ve servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (6, 'Tavuk Salata', 'Salata', 120,
                                                                    ...
                                                                    'https://vicivedi.com/img/691957.webp',
                                                                                                        20, '1. Tavuk dilimlerini bir tavada pişirin.2. Marul ve domatesleri yıkayın ve doğrayın.3. Doğranmış malzemeleri bir kaseye alın.4. Üzerine tavuk dilimlerini yerleştirin.5. Zeytinyağı ve isteğe bağlı olarak limon suyu ekleyin.6. Hafifçe karıştırın ve servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (7, 'Et Salatası', 'Salata', 120,
                                                                    ...
                                                                    'https://market.amasyaeturunleri.com.tr/wp-content/uploads/evde-lezzetler-hardal-soslu-bonfileli-salata.jpg',
                                                                                                        30, '1. Dana etini küp şeklinde doğrayın ve bir tavada pişirin.2. Marul ve domatesleri yıkayın ve doğrayın.3. Soğanı ince dilimler halinde kesin.4. Pişmiş dana etini, marul, domates ve soğanı bir kasede karıştırın.5. Üzerine zeytinyağı gezdirin ve hafifçe karıştırın.6. Servis tabağına alın ve dilerseniz üzerine nar taneleri serpiştirin.7. Soğuk veya ılık olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (8, 'Sebze Kızartma', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2015/08/karisik-kizartma-yenionecikan.jpg',
                                                                                                        35, '1. Patatesi ve havucu soyun ve yıkayın, ardından küp şeklinde doğrayın.2. Patlıcanı ve kabakları yıkayın ve dilimleyin.3. Sarımsakları ince dilimler halinde kesin.4. Bir tavada yağ kızdırın.5. Hazırladığınız sebzeleri tavaya ekleyin ve kızartın.6. Sebzeler kızarana kadar ara sıra karıştırarak pişirin.7. Kızaran sebzeleri kağıt havlu üzerine alarak fazla yağını süzün.8. Tuz ve isteğe bağlı olarak baharatlar ekleyin.9. Sıcak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (9, 'Zeytinyağlı Kabak Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2019/07/kabak-yemegi-onecikan.jpg',
                                                                                                        40, '1. Kabakları yıkayın ve dilimleyin.2. Soğanı doğrayın, domatesleri küp şeklinde doğrayın ve sarımsakları ezin.3. Bir tencerede zeytinyağını ısıtın.4. Doğranmış soğanları ekleyin ve yumuşayana kadar kavurun.5. Üzerine kabak dilimlerini ekleyin ve hafifçe kavurun.6. Ezilmiş sarımsakları ve doğranmış domatesleri tencereye ilave edin.7. Tuz, karabiber ve isteğe bağlı olarak kırmızı biber ekleyin.8. Kabaklar yumuşayana kadar pişirin.9. Servis yapmadan önce üzerine maydanoz veya dereotu serpiştirerek servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (10, 'Zeytinyağlı Patlıcan Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://i20.haber7.net/resize/1280x720//haber/haber7/photos/2023/14/zeytinyagli_patlican_yemegi_nasil_yapilir_zeytinyagli_patlican_yemegi_tarifi_1680596072_057.jpg',
                                                                                                        45, '1. Patlıcanları alacalı soyun ve halka şeklinde dilimleyin.2. Dilimlenmiş patlıcanları tuzlu suda bekletin.3. Bir tavada zeytinyağını ısıtın.4. İnce doğranmış soğanları ekleyin ve yumuşayana kadar kavurun.5. Soğanların üzerine küp doğranmış domatesleri ekleyin.6. Sebzeler biraz kavrulduktan sonra süzülmüş patlıcan dilimlerini ekleyin ve tüm malzemeleri karıştırın.7. Tuz, karabiber gibi baharatlar ekleyin ve kısık ateşte patlıcanlar yumuşayana kadar pişirin.8. Pişen patlıcan yemeğini servis tabağına alın ve ılık olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (11, 'Zeytinyağlı Brokoli Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2022/01/zeytinyagli-brokoli-yemegi-one-cikan.jpg',
                                                                                                        30, '1. Brokolileri yıkayın ve küçük parçalara ayırın.2. Bir tencerede zeytinyağını ısıtın.3. İnce doğranmış soğanları ekleyin ve yumuşayana kadar kavurun.4. Sarımsakları ekleyin ve kokusu çıkana kadar soteleyin.5. Küçük parçalara ayırdığınız brokolileri tencereye ekleyin.6. Biraz su ilave edin ve tencerenin kapağını kapatın.7. Brokoliler yumuşayana kadar pişirin.8. Tuz ve isteğe bağlı olarak karabiber ekleyin.9. Pişen brokoli yemeğini servis tabağına alın ve ılık olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (12, 'Ispanaklı ve Peynirli Omlet', 'Ogun', 120,
                                                                    ...
                                                                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSOdQCpKz6_EeVCdnHMD_BDNYMLAEaIfqvqfDuDjxKu1jHHyJCYeKXYAxesQESfzzlHz8o&usqp=CAU',
                                                                                                        14, '1. Orta ateşte yapışmaz bir tavada ısıtın.2. Bir kasede yumurtaları çırpın ve tuz ve biberle tatlandırın.3. Doğranmış ıspanakları ve rendelenmiş peyniri yumurtalara ekleyin.4. Karışımı tavaya dökün ve 2-3 dakika pişene kadar pişirin.5. Omleti yarım katlayın ve sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (13, 'Domates ve Salatalık Salatası', 'Salata', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2022/10/domates-salatasi-sunum-yemekcom.jpg',
                                                                                                        10, '1. Domatesleri ve salatalıkları ince dilimleyin ve bir kaseye alın.2. Üzerlerine zeytinyağı gezdirin ve tuz ve biber serpin.3. Nazikçe karıştırın.4. Salatanın lezzetinin iyileşmesi için birkaç dakika bekletin.5. Yan yemek veya hafif bir öğün olarak soğuk servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (14, 'Limon Soslu Patates Salatası', 'Salata', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/940/940/uploads/2020/01/patates-salatasi-yemekcom.jpg', 30,
                                                                                                        '1. Patatesleri haşlayın, sonra soğutun ve doğrayın.2. Geniş bir kasede, limon suyunu ve zeytinyağını sos yapmak için karıştırın.3. Dilimlenmiş patatesleri kaba ekleyin ve sosla kaplanana kadar karıştırın.4. İnce doğranmış maydanozu ekleyin, tuz ve biberle tatlandırın.5. İsteğe bağlı olarak taze maydanozla süsleyin ve soğuk servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (15, 'Mantar Sote', 'Ogun', 120,
                                                                    ...
                                                                    'https://www.becel.com/tr-tr/-/media/Project/Upfield/Brands/Becel-NL/Becel-TR/Assets/Recipes/sync-images/e2287947-c156-45ac-86e0-7830d4ce963e.jpg?rev=06e4dc765dd04814bac4d75ff9b024bf&w=900',
                                                                                                        20, '1. Mantarları temizleyin ve dilimleyin.2. Sarımsakları ince doğrayın.3. Bir tavada zeytinyağını ısıtın ve doğranmış sarımsakları ekleyin.4. Sarımsaklar hafifçe kavrulduktan sonra mantarları ekleyin.5. Mantarlar suyunu salıp çekene kadar pişirin.6. Tuz ve isteğe bağlı olarak karabiber ekleyin.7. Mantar soteyi sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (16, 'Kereviz Salatası', 'Salata', 120,
                                                                    ...
                                                                    'https://cdn.ye-mek.net/App_UI/Img/out/650/2019/09/cig-kereviz-salatasi-resimli-yemek-tarifi(7).jpg',
                                                                                                        20, '1. Kerevizi soyun ve ince dilimleyin.2. Limonun suyunu sıkın ve kereviz dilimleriyle karıştırın.3. Zeytinyağı ekleyin ve iyice karıştırın.4. Kereviz salatasını buzdolabında bir süre dinlendirin.5. Soğuk olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (17, 'Bezelye Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://i.lezzet.com.tr/images-xxlarge-recipe/konserve-bezelye-yemegi-99995542-b088-4652-aa0f-2512271f295e.jpg',
                                                                                                        60, '1. Bezelyeleri yıkayın ve süzün.2. Soğanı ince doğrayın. Patatesi ve havucu küp şeklinde doğrayın.3. Bir tencerede zeytinyağını ısıtın ve doğranmış soğanı ekleyin.4. Soğanlar şeffaflaşana kadar kavurun.5. Kavrulmuş soğanın üzerine doğranmış patates ve havuçları ekleyin.6. Biraz su ekleyin ve sebzeler yumuşayana kadar pişirin.7. Bezelyeleri ekleyin ve pişirme işlemine devam edin.8. Tuz ekleyin ve karıştırın.9. Bezelye yemeğini sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (18, 'Pırasa Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/940/940/uploads/2019/12/terbiyeli-pirasa-yemegi-tarifi.jpg',
                                                                                                        35, '1. Pırasaları yıkayın ve ince doğrayın.2. Soğanı ince doğrayın. Havucu küp şeklinde doğrayın.3. Bir tencerede zeytinyağını ısıtın ve doğranmış soğanı ekleyin.4. Soğanlar yumuşayana kadar kavurun.5. Kavrulmuş soğanın üzerine doğranmış pırasa ve havuçları ekleyin.6. Biraz su ekleyin ve sebzeler yumuşayana kadar pişirin.7. Tuz ekleyin ve karıştırın.8. Pırasa yemeğini sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (19, 'Kereviz Yemeği', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2015/10/portakalli-kereviz-yeni-onecikan.jpg',
                                                                                                        45, '1. Kereviz köklerini, patatesi ve havucu soyun ve küp şeklinde doğrayın.2. Soğanı ince doğrayın.3. Bir tencerede zeytinyağını ısıtın ve doğranmış soğanı ekleyin.4. Soğanlar şeffaflaşana kadar kavurun.5. Kavrulmuş soğanın üzerine doğranmış kerevizleri, patatesleri ve havuçları ekleyin.6. Biraz su ekleyin ve sebzeler yumuşayana kadar pişirin.7. Tuz ekleyin ve karıştırın.8. Kereviz yemeğini sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (20, 'Elmalı Tart', 'Tatli', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/1250/833/uploads/2020/10/elmali-turta-tarifi-yemekcom.jpg',
                                                                                                        60, '1. Hamur için un, tuz ve suyu birleştirin ve hamur yoğurun.2. Hamuru tart kalıbına yayın.3. Elma dilimlerini hamurun üzerine düzenleyin.4. Üzerine şeker serpin ve fırında pişirin.5. Soğuduktan sonra dilimleyip servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (21, 'Muzlu Smoothie', 'Icecek', 120,
                                                                    ...
                                                                    'https://www.acibadem.com.tr/hayat/Images/YayinTarifler/muzlu-smoothie_6218_1.jpg',
                                                                                                       10, '1. Muzları dilimleyin.2. Blenderde muz dilimleri ve sütü pürüzsüz bir kıvam alana kadar karıştırın.3. İsteğe bağlı olarak bal veya tatlandırıcı ekleyin.4. Bardaklara dökün ve taze olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (22, 'Domates Çorbası', 'Corba', 120,
                                                                    ...
                                                                    'https://iasbh.tmgrup.com.tr/86f9f1/1200/627/0/60/1500/844?u=https://isbh.tmgrup.com.tr/sbh/2019/08/21/domates-corbasi-tarifi-en-guzel-kremali-domates-corbasi-nasil-yapilir-1566386388767.jpg',
                                                                                                        40, '1. Domatesleri rendeleyin.2. Soğanı ince doğrayın.3. Bir tencerede zeytinyağını ısıtın ve doğranmış soğanı ekleyin.4. Soğanlar şeffaflaşana kadar kavurun.5. Kavrulmuş soğanın üzerine rendelenmiş domatesleri ekleyin.6. Biraz su ekleyin ve domatesler pişene kadar pişirin.7. Tuz ve pul biber ekleyin.8. Çorbayı blendırdan geçirin ve sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (23, 'Elmalı Kek', 'Tatli', 120,
                                                                    ...
                                                                    'https://cdn.ye-mek.net/App_UI/Img/out/650/2023/06/arasi-elmali-kek-resimli-yemek-tarifi(16).jpg',
                                                                                                        50, '1. Elma dilimlerini hazırlayın.2. Hamur için un, tuz, yumurta, süt ve şekerle hamur yoğurun.3. Kek kalıbına hamuru dökün.4. Üzerine elma dilimlerini yerleştirin.5. Fırında pişirin ve soğuduktan sonra dilimleyip servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (24, 'Tavuk Çorbası', 'Corba', 120,
                                                                    ...
                                                                    'https://i.nefisyemektarifleri.com/2020/11/16/5-dakikada-pratik-tavuk-corbasi-sifa-corbasi-2.jpg',
                                                                                                        60, '1. Tavuk etini yıkayın ve küp şeklinde doğrayın.2. Soğanı ince doğrayın.3. Bir tencerede zeytinyağını ısıtın ve doğranmış soğanı ekleyin.4. Soğanlar şeffaflaşana kadar kavurun.5. Kavrulmuş soğanın üzerine doğranmış tavuk etlerini ekleyin.6. Üzerine su ekleyin ve tavuklar pişene kadar pişirin.7. Tuz ve karabiber ekleyin.8. Çorbayı sıcak olarak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (25, 'Elmalı Krep', 'Tatli', 120,
                                                                    ...
                                                                    'https://i.lezzet.com.tr/images-xxlarge-recipe/elmali_krep_tatlisi-504f96ce-8d24-47c8-8df7-1abe8aaa4814.jpg',
                                                                                                        30, '1. Elmaları soyun ve dilimleyin.2. Yumurtaları çırpın ve un ile karıştırın.3. Tavada yağı ısıtın ve bir kepçe hamur dökün.4. Üzerine elma dilimlerini yerleştirin ve diğer tarafı pişene kadar bekleyin.5. Pişen krepleri dilimleyerek servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (26, 'Ananaslı Kek', 'Tatli', 120,
                                                                    ...
                                                                    'https://hanemdepisenler.com/wp-content/uploads/2012/06/1-sany1500.jpg',
                                                                                                        60, '1. Ananası soyun ve küp şeklinde doğrayın.2. Un, yumurta, şeker, süt ve erimiş tereyağını bir kasede karıştırın.3. Karışıma doğranmış ananası ekleyin ve karıştırın.4. Hazırladığınız hamuru yağlanmış bir kek kalıbına dökün.5. Önceden ısıtılmış 180 derece fırında yaklaşık 40-45 dakika pişirin.6. Fırından çıkarıp soğuduktan sonra dilimleyerek servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (27, 'Köfte Izgara', 'Ogun', 120,
                                                                    ...
                                                                    'https://d17wu0fn6x6rgz.cloudfront.net/img/w/tarif/mgt/izgara-kofte-1.webp',
                                                                                                        30, '1. Kıymayı bir kaba alın.2. Tuz ve isteğe bağlı olarak diğer baharatları ekleyin ve iyice yoğurun.3. Yoğrulan kıymadan küçük parçalar alıp yuvarlayarak köfte şekli verin.4. Izgara tavasını ısıtın ve köfteleri her iki tarafı da iyice pişene kadar pişirin.5. Pişen köfteleri sıcak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (28, 'Tavuk Izgara', 'Ogun', 120,
                                                                    ...
                                                                    'https://www.tavukiyidir.com/img/blog/blog_1108677.jpg',
                                                                                                        40, '1. Tavuk göğüs etlerini yıkayın ve kurulayın.2. Tavuk etlerine isteğe bağlı baharatları ve zeytinyağını ekleyin ve marine edin.3. Izgara tavasını veya ızgarayı önceden ısıtın.4. Tavuk etlerini ızgaraya yerleştirin ve her iki tarafı da altın rengi olana kadar pişirin.5. Pişen tavukları sıcak servis yapın.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (29, 'Tavuk Şinitzel', 'Ogun', 120,
                                                                    ...
                                                                    'https://api.developerkitchen.com/uploads/1599247813170221616.jpg',
                                                                                                        30, '1. Tavuk göğüs etlerini inceltmek için bir dövme tokmak kullanarak yumuşak bir şekilde vurun.2. Tavuk göğsü parçalarını una batırın.3. Bir tavada yağı ısıtın ve tavuk parçalarını her iki tarafı da altın rengi olana kadar kızartın.4. Pişmiş tavukları kağıt havlu ile süzün.5. Sıcak servis yapın, isteğe bağlı olarak limon dilimleriyle servis yapabilirsiniz.');
...
INSERT INTO recipe (id, name, category, calories, description, image, total_time, instructions) VALUES (30, 'Et Şinitzel', 'Ogun', 120,
                                                                    ...
                                                                    'https://cdn.yemek.com/mnresize/940/940/uploads/2023/09/dana-sinitzel.jpg',
                                                                                                        40, '1. Dana etini inceltmek için bir dövme tokmak kullanarak yumuşak bir şekilde vurun.2. Dana eti parçalarını una batırın.3. Bir tavada yağı ısıtın ve et parçalarını her iki tarafı da altın rengi olana kadar kızartın.4. Pişmiş etleri kağıt havlu ile süzün.5. Sıcak servis yapın, isteğe bağlı olarak limon dilimleriyle servis yapabilirsiniz.');
